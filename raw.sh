...
#       -m gs2as --Gscale=1.2e-17 --Ascale=86400.0 --modnam=E3SM_1PCTCO2FUL --caseid=mpaso.hist.am.timeSeriesStatsMonthly \
#       --strtyr=1900 --stopyr=2049 --itype=raw
#
#./comp_global_time_series.sh -b /global/cfs/cdirs/m3522/1pctco2_temp/20191020.CO21PCTCTL_RUBISCO_CNPCTC1850_OIBGC.ne30_oECv3.compy/run -v timeMonthly_avg_CO2_gas_flux \
#       -m gs2as --Gscale=1.2e-17 --Ascale=86400.0 --modnam=E3SM_1PCTCO2CTL --caseid=mpaso.hist.am.timeSeriesStatsMonthly \
#       --strtyr=1900 --stopyr=2049 --itype=raw
...
./comp_global_time_series.sh -b /global/cfs/cdirs/m3522/1pctco2_temp/20191020.CO21PCTCTL_RUBISCO_CNPCTC1850_OIBGC.ne30_oECv3.compy/run -v NEE \
...
#./comp_global_time_series.sh -b /global/cfs/cdirs/m3522/1pctco2_temp/20191123.CO21PCTFUL_RUBISCO_CNPCTC20TR_OIBGC.I1900.ne30_oECv3.compy/run -v GPP \
#       -m gs1as --Gscale=1.e-9 --Ascale=86400.0 --modnam=E3SM_1PCTCO2FUL --caseid=20191123.CO21PCTFUL_RUBISCO_CNPCTC20TR_OIBGC.I1900.ne30_oECv3.compy.clm2 \
#       --strtyr=1900 --stopyr=2049 --itype=raw
#
#
...
#./comp_global_time_series.sh -b /global/cfs/cdirs/m3522/1pctco2_temp/20191020.CO21PCTCTL_RUBISCO_CNPCTC1850_OIBGC.ne30_oECv3.compy/run -v GPP \
#       -m gs1as --Gscale=1.e-9 --Ascale=86400.0 --modnam=E3SM_1PCTCO2CTL --caseid=20191020.CO21PCTCTL_RUBISCO_CNPCTC1850_OIBGC.ne30_oECv3.compy.clm2 \
#       --strtyr=1900 --stopyr=2049 --itype=raw
...
#./comp_global_time_series.sh -b /global/cfs/cdirs/m3522/1pctco2_temp/20191123.CO21PCTFUL_RUBISCO_CNPCTC20TR_OIBGC.I1900.ne30_oECv3.compy/run -v COL_FIRE_CLOSS \
#       -m gs1as --Gscale=1.e-9 --Ascale=86400.0 --modnam=E3SM_1PCTCO2FUL --caseid=20191123.CO21PCTFUL_RUBISCO_CNPCTC20TR_OIBGC.I1900.ne30_oECv3.compy.clm2 \
#       --strtyr=1900 --stopyr=2049 --itype=raw

./comp_global_time_series.sh -b /global/cfs/cdirs/m3522/1pctco2_temp/20191020.CO21PCTCTL_RUBISCO_CNPCTC1850_OIBGC.ne30_oECv3.compy/run -v COL_FIRE_CLOSS \
       -m gs1as --Gscale=1.e-9 --Ascale=86400.0 --modnam=E3SM_1PCTCO2CTL --caseid=20191020.CO21PCTCTL_RUBISCO_CNPCTC1850_OIBGC.ne30_oECv3.compy.clm2 \
       --strtyr=1900 --stopyr=2049 --itype=raw
#./comp_global_time_series.sh -b /global/cfs/cdirs/m3522/1pctco2_temp/20191123.CO21PCTFUL_RUBISCO_CNPCTC20TR_OIBGC.I1900.ne30_oECv3.compy/run -v COL_FIRE_CLOSS \
#       -m gs1as --Gscale=1.e-9 --Ascale=86400.0 --modnam=E3SM_1PCTCO2FUL --caseid=20191123.CO21PCTFUL_RUBISCO_CNPCTC20TR_OIBGC.I1900.ne30_oECv3.compy.clm2 \
